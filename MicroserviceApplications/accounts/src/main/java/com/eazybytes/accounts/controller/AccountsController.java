...
//    }
    ...
    @Operation(
            ...
            description = "REST API to know the current build version"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
                    description = "HTTP Status sent"
            ),
            @ApiResponse(
                    responseCode = "500",
                    description = "HTTP Status Internal Server Error",
    ...
    @Operation(
            ...
            description = "REST API to know the current java version"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<String> getJavaVersion(){
        return new ResponseEntity<>("java 21",HttpStatus.OK);
    }

    public ResponseEntity<String> getJavaVersionFallback(Throwable throwable){
        return new ResponseEntity<>("Java 17v",HttpStatus.OK);
    }

    @Operation(
            summary = "Get contact information REST API",
            description = "REST API to know the information of the developer who created this application."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<AccountsContactInfoDto> getConfigurationProperties() {
